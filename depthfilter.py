...
def depthcallback(msg):
    global depth_filter
    depth = bridge.imgmsg_to_cv2(msg,msg.encoding)[30:510,160:800]
    # [30:510,160:800] 640*480
    # [150:390,320:640] 320*240
    ...
    dilation = cv2.dilate(Blur,kernel[1],iterations=1)
...
def imagecallback(msg):
    ...
    img = bridge.imgmsg_to_cv2(msg,"bgr8")[30:510,160:800]
